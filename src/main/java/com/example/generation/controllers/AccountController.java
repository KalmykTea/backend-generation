...
public class AccountController {
    ...
    final private AccountRequestDTOMapper requestDTOMapper;

    public AccountController(AccountService accountService, AccountRequestDTOMapper accountRequestDTOMapper) {
        this.accountService = accountService;
        this.requestDTOMapper = accountRequestDTOMapper;
    }
    ...
    public Account update(
            ...
            return accountService.update(requestDTOMapper.toEntity(accountRequestDTO), id);
    }
}
